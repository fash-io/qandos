...
const features = [
  ...
  },
  {
    ...
    img: escrowImg,
    points: [
      "Licensed escrow account",
      "Release on buyer approval",
      "Full refund if title fails",
    ],
    icon: Banknote,
  },
];
  ...
  return (
    <>
        ...
        <div className="container-q pt-20 md:pt-10 pb-24 md:pb-32 grid md:grid-cols-12 gap-10 items-center">
          <div className="md:col-span-6">
            ...
            <p className="mt-6 max-w-lg text-lg text-muted-foreground">
              We verify property ownership, documentation and legitimacy on your
              behalf — so the only thing you're buying is the land you were
              promised.
            </p>
          ...
          <div className="md:col-span-6 md:scale-75">
            <div className="relative">
              ...
              <img
                ...
                className="rounded-3xl w-full max-w-160 mx-auto aspect-square"
              />
              <div className="absolute -bottom-6 -left-6 hidden md:flex items-center gap-3 rounded-2xl bg-card p-4 shadow-(--shadow-soft) border border-border">
                <span
        ...
        <div className="container-q py-20 grid md:grid-cols-3 gap-8 items-center">
          <div className="flex items-center gap-3">
            ...
            <p className="font-display text-xl">
              Real estate fraud is industrial.
            </p>
          </div>
      ...
      <section className="container-q pb-24">
        <figure
          className="rounded-3xl p-10 md:p-16 grain"
          style={{ background: "var(--lime)" }}
        >
          <blockquote className="font-display text-3xl md:text-4xl leading-tight max-w-3xl">
            "We almost paid ₦42M for a plot that didn't legally exist. QANDOS
            caught it in 6 days. That report saved my family"
          </blockquote>
          <figcaption className="mt-8 text-sm">
            <span className="font-medium">Adaeze O.</span>
            <span className="text-muted-foreground">
              {" "}
              — Diaspora buyer, Ikoyi
            </span>
          </figcaption>
        </figure>
      </section>
      ...
      <section className="container-q pb-32">
        ...
        >
          ...
          <p
            ...
            style={{ color: "oklch(0.985 0.012 95 / 0.7)" }}
          >
          ...
          <div className="mt-8 flex flex-wrap gap-3 justify-center">
            ...
            <a
              ...
              style={{
                color: "var(--cream)",
                borderColor: "oklch(0.985 0.012 95 / 0.2)",
              }}
            >
              About QANDOS
            </a>
  ...
  return (
    <div>
      ...
      <p
        ...
        style={{ color: "oklch(0.97 0.02 90 / 0.75)" }}
      >
        {label}
      </p>
    </div>
      ...
      <div className="md:col-span-6">
        <div className="relative">
          ...
          <img
            ...
            height={960}
            loading="lazy"
            className="rounded-3xl w-full h-auto shadow-(--shadow-soft) border border-border"
          />
        </div>
      </div>
      <div className="md:col-span-6">
        ...
        <div className="mt-8 inline-flex items-center gap-2 text-sm">
          ...
          <a href="/how-it-works" className="font-medium hover:underline">
            Inside the process →
          </a>
        </div>
      </div>
