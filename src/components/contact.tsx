        ...
        <div className="grid md:grid-cols-12 gap-12">
          <div className="md:col-span-5">
            ...
            <p className="mt-6 text-lg text-muted-foreground">
              Tell us what you're looking at. We respond within one business day
              with a fixed quote and timeline — usually 7–10 working days.
            </p>
          ...
          <div className="md:col-span-7">
            <form
              ...
              className="rounded-3xl bg-card border border-border p-8 md:p-10 shadow-(--shadow-soft)"
            >
              {sent ? (
