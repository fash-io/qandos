...
const values = [
  {
    title: "Independent",
    body: "We never take a cent from sellers, listing platforms or agents. Our only client is the person about to pay.",
  },
  {
    title: "Evidence-based",
    body: "Every verdict ships with photographs, registry receipts and a paper trail you could take to court.",
  },
  {
    title: "Accountable",
    body: "If we clear a title and it turns out fraudulent, we refund our fee — and assist with recovery.",
  },
];
...
export function About() {
  return (
    <>
        ...
        <div className="grid md:grid-cols-12 gap-12 items-end">
          <div className="md:col-span-7">
            ...
            <h1 className="mt-6 text-5xl md:text-6xl">
              Built because too many
              <br />
              good people lost everything.
            </h1>
          </div>
          <div className="md:col-span-5">
            <p className="text-lg text-muted-foreground">
              QANDOS was founded after one too many friends, family members and
              clients sent millions to sellers who never owned the land they
              were selling. The system was broken. So we built the check that
      ...
      <section className="py-20 md:py-28" style={{ background: "var(--lime)" }}>
