    ...
    <>
      <section className="container-q pt-20 pb-16 md:pt-28">
        ...
        <p className="mt-6 max-w-xl text-lg text-muted-foreground">
          Every QANDOS verification combines registry research, on-site
          inspection and a clear written verdict. Here's exactly what happens.
        </p>
      </section>
        ...
        <ol className="relative grid gap-6">
          {steps.map((s, i) => (
            <li
              ...
              style={{
                background: i % 2 === 0 ? "var(--card)" : "oklch(0.97 0.02 95)",
              }}
            >
